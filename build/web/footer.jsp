<%-- 
    Document   : footer
    Created on : Oct 15, 2022, 2:12:27 PM
    Author     : kausar
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
  <footer class="flex justify-center px-4 text-gray-800 bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-fuchsia-300 via-green-400 to-rose-700">
