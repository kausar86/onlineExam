<%-- 
    Document   : editStudentbyAdmin
    Created on : Oct 20, 2022, 3:55:46 AM
    Author     : kausar
--%>
...
<html>
      ...
      <body>
            ...
            <div  class="h-auto w-11/12 md:w-2/5 lg:w-2/5 p-3 mx-auto mb-4 mt-4 bg-gradient-to-r from-yellow-400 via-gray-50 to-teal-300 rounded-md ">
                  <div class="flex flex-col w-full h-auto ">
                        <!-- Header -->
                        <div class="flex w-full h-auto justify-center items-center">
                              <div class="flex w-11/12 lg:w-8/12 h-auto py-1 justify-center items-center text-2xl font-bold ">
                                    Online Exam Student Profile 
                              </div>
                              <!--Header End-->
                        </div>
                        <!-- Modal Content-->
                        <div class="flex w-full h-auto py-1 px-2 justify-center items-center flex-col bg-radial from-amber-200 via-violet-600 to-sky-900 rounded text-center text-gray-500">
                              ...
                              <!--<h1 class="text-2xl text-center text-black font-bold mt-2 mb-2"> <%= User.getStudentName()%></h1>-->
                              <!--Profile Edit--> 
                              <form action="editStudentByAdmin" method="post" enctype="multipart/form-data">
                                    <table class="min-w-full"> 
                                          <tr class= lg:border-b  transition duration-300 ease-in-out hover:bg-gray-100">
                                                ...
                                                <td class=" whitespace-nowrap text-sm font-bold text-green-600"> <input type="text" name="userId" class="pr-4 pl-10 py-2 bg-green-100 border focus:ring-gray-500 focus:border-gray-900  sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" value="<%=User.getUserId()%>"></td>
                                          </tr>
                                          <tr class= lg:border-b  transition duration-300 ease-in-out hover:bg-gray-100">
                                                <th scope="col" class="text-sm font-bold text-green-600 px-2 py-2   text-left">
                                                      Name:
                                          ...
                                          <tr class= lg:border-b  transition duration-300 ease-in-out hover:bg-gray-100">
                                                ...
                                                <td class=" whitespace-nowrap text-sm font-bold text-green-600">  
                                                      ...
                                                      <select name="qualification" class="pr-32 pl-14 bg-green-100 py-2 border focus:ring-gray-500 focus:border-gray-900  sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
