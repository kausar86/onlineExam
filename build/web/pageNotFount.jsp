<%-- 
    Document   : pageNotFount
    Created on : Oct 5, 2022, 1:48:42 AM
    Author     : kausar
--%>
                  ...
                  <div class="w-9/12 m-auto py-8 min-h-screen flex items-center justify-center">
                        <div class="bg-white  shadow overflow-hidden sm:rounded-lg pb-8">
                              <div class="border-t border-gray-200 text-center pt-8">
                                    ...
                                    <a href="index.jsp" class="bg-gradient-to-r from-purple-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md mr-6">
                                          HOME
                                    </a>
